"""
Django settings for himanshutest_1 project.
...
ROOT_URLCONF = 'himanshutest_1.urls'
...
WSGI_APPLICATION = 'himanshutest_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Himanshutest Support <support@himanshutest-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "himanshutest_1 API",
    "DESCRIPTION": "API documentation for himanshutest_1 App",
    "VERSION": "v1",
}
